...
This project upgrades the cubic spline implementation to ES6.  Additionally, it demonstrates a COMB functions alternative via piecewise length.  The ReactJS code-kata is composed of the following actions.
